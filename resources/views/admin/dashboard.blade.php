    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p>
                        Ini adalah halaman utama Panel Admin Anda. Gunakan menu navigasi di sebelah kiri untuk mulai mengelola konten website profil Anda.
                    </p>
                </div>
            </div>
        </div>
        <!-- [ Kartu Selamat Datang ] end -->
